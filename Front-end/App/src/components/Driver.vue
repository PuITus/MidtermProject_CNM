  ...
  <div id="driver" class="container  mt-5" >
    ...
    <div class="col-md-12 load3" style = "background:#1D4569;text-align:center;">
      <p >    <strong>- Name:</strong> {{askingrq.Name}} <br>
        ...
        <img width="100%" src="https://image.ibb.co/gcvdx0/ezgif-com-crop.gif" alt="aa">
      </div>
...
<div class="col-12">
  <button v-if="picked" v-on:click ="sendDone" class=" col-12 btn btn-success" >Done</button>
  <button v-if="!picked" v-on:click ="sendPicked" class=" col-12 btn btn-success" >Picked</button>
</div>
<transition name="fade">
  ...
  <div v-if="picknoti" class="notifications alert alert-primary">
    <strong>Picked up the customer!</strong> <br>
  </div>
...
export default {
  ...
  methods: {
    ...
    {  
      ...
      this.picked = true;
      this.picknoti = true;
      setTimeout(function (){ vm.picknoti = false;}, 3000);
    },
