    ...
    function sendSuccess (ws,Data) {
      ...
      socketServer.on('connection', ws => {
        ...
        .on('reject', function (data) {
          ...
          if(ws.currentRequest.Times == Config.TX)
          {
           requestRepo.setStatus(ws.currentRequest.ID,'5').then(
            value => {
         ...
         else  findDriver(ws.currentRequest);
       })
